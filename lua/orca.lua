...
function orca.load_plugin_syntax()
	local plugin_syntax = {
		...
		TSNamespace = { fg = orca.comment_grey },
		TSNone = { fg = orca.fg },
		TSNumber = { fg = orca.orange },
		...
		TSVariableBuiltin = { fg = orca.light_green },
